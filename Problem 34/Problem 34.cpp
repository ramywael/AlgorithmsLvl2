...
int main() {
	...
	short searched_number = ReadPostiveNumber("Please Enter A number to Search for");
	short searched_number_index= FindNumberPositionInArray(arr, lengthNumber, searched_number);
	if (searched_number_index == -1) {
		cout << "The Number is not found :-(";
	}
	else {
		cout << "The Number Found at position : " << searched_number_index << "\n";
		cout << "The Number Found its order :" << searched_number_index + 1 << "\n";
	}
